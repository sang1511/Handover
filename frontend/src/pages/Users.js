...
const Users = () => {
  ...
  const handleAddUser = () => {
    ...
    // TODO: Implement navigation or modal for adding user
  };
    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap', gap: 2 }}>
        ...
        <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
          ...
          <Button variant="contained" startIcon={<AddIcon />} onClick={handleAddUser} style={{ backgroundColor: '#EA3252', color: '#ffffff' }}>
            Thêm người dùng
          </Button>
        </Box>
      </Box>
